...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function updateDelivery(AdminContext $context)
    {
        ...
        $this->addFlash('notice', '<span style="color:green"><strong>'.$order->getReference().' est bien en cours de livraison</strong></span>');
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ChoiceField::new('state', 'Statut de la commande')->setChoices([
                "Non payée" => 0,
                "Payé" => 1,
